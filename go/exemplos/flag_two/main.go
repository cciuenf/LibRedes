...
//
//	Terminal 1 — nó central COM RUÍDO:
//	  cd go/physical_medium
//	  go run . -udp :9000 -ctrl :9090 -profiles profiles/noisy.json
//
...
const (
	...
	// No TCP real seria aleatório. Aqui usamos 32768 para depuração.
...
// =============================================================================
// main — fluxo principal da captura da Flag 2
// =============================================================================
//
// O fluxo é sequencial e síncrono. Cada passo bloqueia até completar.
// Isso simplifica o código didático (um TCP real seria assíncrono).
...
//   20     |   N   | Payload (opcional)  | (vazio)        | "GET /flag2..."
//
